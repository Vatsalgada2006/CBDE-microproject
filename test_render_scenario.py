import os
# Simulate Render environment: Firebase config present but storage bucket missing
os.environ['FIREBASE_PROJECT_ID'] = 'dummy-project'
os.environ['FIREBASE_CLIENT_EMAIL'] = 'dummy@dummy-project.iam.gserviceaccount.com'
os.environ['FIREBASE_PRIVATE_KEY'] = '-----BEGIN PRIVATE KEY-----\nMIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDdummy\n-----END PRIVATE KEY-----'
# Note: NOT setting FIREBASE_STORAGE_BUCKET to simulate the issue
...
try:
    ...
    if Config.FIREBASE_STORAGE_BUCKET:
        ...
        print("In the actual application, this would raise a clear ValueError")
